            ...
            if ($action === 'approve_acta') {
                ...
                foreach ($notes_to_approve_details as $note_detail) {
                    try {
                        ...
                        error_log("DEBUG (admin/actas.php): Nota de inscripcion_id " . $note_detail['id_inscripcion'] . " (Estudiante: " . $note_detail['id_estudiante'] . ", Asignatura: " . $note_detail['id_asignatura'] . ") registrada/actualizada en historial_academico. Rows affected: " . $stmt_upsert_historial->rowCount());
                        ...
                        // Por ahora, lo logueamos y la transacción principal continuará
                    }
                }
